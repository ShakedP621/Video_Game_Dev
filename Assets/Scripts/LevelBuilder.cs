...
public class LevelBuilder : MonoBehaviour
{
	...
	StartRoom startRoom;
	EndRoom endRoom;
	public static List<Room> placedRooms = new List<Room> ();
	private NavMeshBuilder nmb;
		...
		if (colliders.Length > 0) {
			...
			foreach (Collider c in colliders) {
				if (c.transform.parent.gameObject.Equals(room.gameObject) ||
					c.transform.parent.gameObject.Equals(startRoom.gameObject) ||
					c.transform.parent.gameObject.Equals(endRoom.gameObject)) {
					continue;
				} else {
